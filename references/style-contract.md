...
- Figures (from `assets/primitives/`) anchor a scene when the concept involves a person/user/team; standalone prop illustrations (lightbulb, shield, chart, etc.) work alone when the concept is more abstract (an idea, a system property, a metric).
